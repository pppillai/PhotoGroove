			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							selectedUrl: $author$project$PhotoGroove$getPhotoUrl(_int)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$PhotoGroove$Checked = function (a) {
	return {$: 'Checked', a: a};
};
var $author$project$PhotoGroove$setChecked = F3(
	function (model, thumbnailSize, ischecked) {
		return ischecked ? $author$project$PhotoGroove$Checked(thumbnailSize) : $author$project$PhotoGroove$Checked(model.choosenSize);
	});
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($author$project$PhotoGroove$setChecked, model, thumbnailSize)),
							$elm$html$Html$Attributes$checked(
							_Utils_eq(model.choosenSize, thumbnailSize) ? true : false)
						]),
					_List_Nil),
					$elm$html$Html$text(
					$author$project$PhotoGroove$sizeToString(thumbnailSize))
				]));
	});
